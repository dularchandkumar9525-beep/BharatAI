        ...
        {schemes.length > 0 && (
          <section className="mt-10">
            <div className="mb-5">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Neeche di gayi schemes ko official portal par verify karein.
              </p>
            </div>
            ...
            <div className="space-y-5">
              {schemes.map((scheme, index) => (
                <article
                  key={index}
                  className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-lg transition hover:shadow-xl"
                >
                  <div className="border-b bg-gray-50 p-5 sm:p-6">
                    ...
                    {scheme.apply_url && (
                      <div className="border-t pt-5">
                        <a
                          ...
                          className="inline-flex w-full items-center justify-center rounded-xl bg-green-600 px-5 py-3.5 font-bold text-white shadow-md transition hover:bg-green-700 sm:w-auto"
                        >
